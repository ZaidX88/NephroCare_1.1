...
function SignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    // Add logic for sign-up authentication here
    console.log('Name:', name, 'Email:', email, 'MBBS:', mbbs, 'Sex:', sex, 'Password:', password);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="mbbs" className="block text-gray-700 font-medium mb-2">
              MBBS
            </label>
            <input
              type="text"
